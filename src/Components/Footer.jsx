        ...
        <div className="container py-5">
            <div className="row g-5">
                <div className="col-lg-4 col-md-6">
                    ...
                    <p className="mb-2"><i className="fa fa-phone-alt me-3"></i><Link className='text-light' to="tel:9608267530">+91-9608267530</Link></p>
                    <p className="mb-2"><i className="fa fa-envelope me-3"></i><Link className='text-light' to="mailto:vimalbhartiofficial@gmail.com">vimalbhartiofficial@gmail.com</Link> </p>
