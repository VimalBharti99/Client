                    ...
                    <div className="row gy-4">
                        <div className="col-md-4">
                            <div className="bg-light d-flex flex-column justify-content-center p-4">
                                ...
                                <p className="m-0"><i className="fa fa-home text-primary me-2"></i>Delhi, India</p>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="bg-light d-flex flex-column justify-content-center p-4">
                                <h5 className="text-uppercase"> Email :-</h5>
                                <p className="m-0"><i className="fa fa-envelope text-primary me-2"></i><a href="mailto:rafiehayat5@gmail.com" className='text-dark'>rafiehayat5@gmail.com</a></p>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="bg-light d-flex flex-column justify-content-center p-4">
                                <h5 className="text-uppercase"> Phone :-</h5>
                                <p className="m-0"><i className="fa fa-phone text-primary me-2"></i><a href="tel:+91 7979973557" className='text-dark'>+91-7979973557</a></p>
                            </div>
                        </div>
                    </div>
                </div>
