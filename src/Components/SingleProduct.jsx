...
export default function SingleProduct() {
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src={`/${data.pic1}`} height="525px" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src={`/${data.pic2}`} height="525px" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src={`/${data.pic3}`} height="525px" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src={`/${data.pic4}`} height="525px" className="d-block w-100" alt="..."/>
    </div>
  </div>
  ...
  <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
   ...
   <div className='d-flex justify-content-between mt-1'>
       <img src={`/${data.pic1}`} height="100px" width="24.7%" alt="" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" className="active" aria-current="true" aria-label="Slide 1" />
       <img src={`/${data.pic2}`} height="100px" width="24.7%" alt="" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2" />
       <img src={`/${data.pic3}`} height="100px" width="24.7%" alt="" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3" />
       <img src={`/${data.pic4}`} height="100px" width="24.7%" alt="" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3" aria-label="Slide 4"/>
   </div>
     </div>
          <div className="col-md-6">
              ...
              <tbody>
                 ...
                 <tr>
                   ...
                   <p className=' text-center fs-6' style={{width:"10%"}}>{qty}</p>
                    ...
                    <tr>
                    <td colSpan={2}>
                    <button className='btn btn-primary w-50' onClick={addToCart}><i className='fa fa-shopping-cart'>Add to Cart</i></button>
                    ...
                    <div className="team-item">
                        <div className="position-relative overflow-hidden">
                            ...
                            <div className="team-overlay position-absolute start-0 top-0 w-100 h-100">
                                <img src={`/${item.pic2}`} className='position-absolute start-0 top-0 w-100 h-100' style={{height:"230px",width:"100%"}}></img>
